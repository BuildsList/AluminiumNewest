...
/obj/item/clothing/suit/armor/vest/handmade/bad
	name = "handmade armor"
	desc = "An handmade armored vest that protects against some damage."
	icon_state = "handarmor"
	item_state = "armor"
	blood_overlay_type = "armor"
	flags = FPRINT | TABLEPASS | ONESIZEFITSALL
	armor = list(melee = 10, bullet = 5, laser = 10, energy = 5, bomb = 10, bio = 0, rad = 0)

/obj/item/clothing/suit/armor/vest/handmade/good
	name = "handmade armor"
	desc = "An handmade armored vest that protects against some damage."
	icon_state = "handarmor"
	item_state = "armor"
