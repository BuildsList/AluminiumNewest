...
/mob/living/carbon/human/updatehealth()
	...
	//TODO: fix husking
	if( ((100 - total_burn) < config.health_threshold_dead) && (stat == DEAD || zombie)) //100 only being used as the magic human max health number, feel free to change it if you add a var for it -- Urist
		ChangeToHusk()
	return
