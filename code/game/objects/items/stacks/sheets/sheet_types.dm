...
var/global/list/datum/stack_recipe/metal_recipes = list ( \
	...
	new/datum/stack_recipe("rack parts", /obj/item/weapon/rack_parts, 1), \
	new/datum/stack_recipe("closet", /obj/structure/closet, 2, time = 15, one_per_turf = 1, on_floor = 1), \
	null, \
	new/datum/stack_recipe("canister", /obj/machinery/portable_atmospherics/canister, 10, time = 15, one_per_turf = 1, on_floor = 1), \
	null, \
	new/datum/stack_recipe("floor tile", /obj/item/stack/tile/plasteel, 1, 4, 20), \
	new/datum/stack_recipe("scrap metal", /obj/item/weapon/craftitems/middlecomponent/scrapmetal, 1), \
	new/datum/stack_recipe("nails", /obj/item/weapon/craftitems/endcomponent/nails, 1), \
	new/datum/stack_recipe("screws", /obj/item/weapon/craftitems/endcomponent/screws, 1), \
...
var/global/list/datum/stack_recipe/wood_recipes = list ( \
	...
	new/datum/stack_recipe("wooden stick", /obj/item/weapon/craftitems/endcomponent/stick, 1), \
