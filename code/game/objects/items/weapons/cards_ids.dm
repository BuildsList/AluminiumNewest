...
/obj/item/weapon/card/id/blue
	name = "identification card"
	desc = "A blue card which shows honour and dedication."
	icon_state = "ocean_regular"
	item_state = "silver_id"

/obj/item/weapon/card/id/red
	name = "identification card"
	desc = "A red card which shows honour and dedication."
	icon_state = "lava_silver"
	item_state = "silver_id"

/obj/item/weapon/card/id/white
	name = "identification card"
	desc = "A white card which shows honour and dedication."
	...
	if(!src.registered_name)
		...
		switch(alert("Would you like to display the ID, or retitle it?","Choose.","Rename","Show"))
			if("Rename")
				...
				var u = copytext(sanitize(input(user, "What occupation would you like to put on this card?\nNote: This will not grant any access levels other than Maintenance.", "Agent card job assignment", "Savage")),1,MAX_MESSAGE_LEN)
				if(!u)
					alert("Invalid assignment.")
					return
				src.assignment = u
