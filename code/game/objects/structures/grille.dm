...
/obj/structure/grille/border/CanPass(atom/movable/mover, turf/target, height=0, air_group=0)
...
/obj/structure/grille/border/CheckExit(atom/movable/O as mob|obj, target as turf)
