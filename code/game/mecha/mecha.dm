...
/obj/mecha/verb/toggle_lights()
	...
	lights = !lights
	if(lights)	ul_SetLuminosity(LuminosityRed + lights_power, LuminosityGreen + lights_power, LuminosityBlue + lights_power)
	else		ul_SetLuminosity(LuminosityRed + lights_power, LuminosityGreen + lights_power, LuminosityBlue + lights_power)
