...
/obj/machinery/hologram/holopad/proc/create_holo(mob/living/silicon/ai/A, turf/T = loc)
	...
	hologram.ul_SetLuminosity(2)	//hologram lighting
	ul_SetLuminosity(2)			//pad lighting
	icon_state = "holopad1"
	A.current = src
...
//	hologram.ul_SetLuminosity(0)//Clear lighting.	//handled by the lighting controller when its ower is deleted
