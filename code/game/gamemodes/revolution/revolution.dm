...
/datum/game_mode/revolution
	...
	restricted_jobs = list("Security Officer", "Warden", "Detective", "AI", "Cyborg","Observer", "Head of Personnel", "Head of Security", "Chief Engineer", "Research Director", "Chief Medical Officer")
	required_players = 4
